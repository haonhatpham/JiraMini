...
const nullableTextSchema = z.preprocess((value) => (value === "" ? null : value), z.string().trim().max(10_000).nullable().optional());
const nullableUuidSchema = z.preprocess((value) => (value === "" ? null : value), uuidSchema.nullable().optional());
const nullableDateOnlySchema = z.preprocess((value) => (value === "" ? null : value), dateOnlySchema.nullable().optional());
